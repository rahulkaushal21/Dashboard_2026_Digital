...
export interface BookingRow { id: number; company_name?: string; booking_month?: string; booking_date?: string; booking_amount?: number; service_name?: string; technology?: string; geo?: string; sme?: string; sales_person?: string; contact_email?: string }
...
export async function getBookingsFull(): Promise<BookingRow[]> { return (await read<BookingRow>('web_revenue', 'id, company_name, booking_month, booking_date, booking_amount, service_name, technology, geo, sme, sales_person, contact_email', 'id')) || [] }
